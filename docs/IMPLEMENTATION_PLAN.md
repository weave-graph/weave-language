...
| L15 | U | Optional governance | Proposal, policy-version and acceptance plans | Personal direct acceptance and governed approval both work; policy mutation cannot grant caller authority | L6 |
...
| L24 | P | Incremental live graphs | Materialize/watch plans, rolling-window clock input and support deltas | Incremental output equals full recomputation across insertion, correction, deletion and expiry | L4 |
