...
print(f'Scalar specialization parity passed: {len(native):,} identical JSON bytes; four scalar cases, three scalar errors, interval values/errors, typed physical/embedding vectors, view and handler artifacts with rejection diagnostics; zero WASM host imports')
